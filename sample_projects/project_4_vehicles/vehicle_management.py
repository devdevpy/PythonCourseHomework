...
from database import add_vehicle, delete_vehicle, get_database, update_vehicle, export_data
...
def map_user_input(user_input: int):
    if user_input == 1:
        vehicle_data = take_add_vehicle_input()
        ...
        raise RuntimeError(f"Unknown user option {user_input}")


def take_add_vehicle_input() -> Tuple[str, str, str, str, str]:
